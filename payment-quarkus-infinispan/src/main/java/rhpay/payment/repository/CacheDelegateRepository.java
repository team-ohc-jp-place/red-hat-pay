...
public class CacheDelegateRepository implements DelegateRepository {
    ...
    public Payment invoke(ShopperId shopperId, TokenId tokenId, CoffeeStore store, Money amount) {
        ...
        try {
            ...
            Payment payment = new Payment(store.getId(), shopperId, new Money(paymentEntity.getPillingAmount()), LocalDateTime.ofEpochSecond(paymentEntity.getBillingDateTime(), 0, ZoneOffset.of("+09:00")), tokenId);
